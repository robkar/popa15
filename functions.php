...
function popa15_scripts() {
	...
	wp_enqueue_style( 'popa15-style', get_stylesheet_uri(), array(), '20150819_3' );
	wp_enqueue_style( 'google-fonts-amaticsc', 'http://fonts.googleapis.com/css?family=Amatic+SC:400,700&subset=latin-ext');
